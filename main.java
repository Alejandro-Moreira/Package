...
public class main {
    public static void main(String[] args) {
        ...
        hiperbole hip = new hiperbole(2.15, 7.15);
        Parabola_Equipo2 parab = new Parabola_Equipo2(7, 15, 3, 8, 2);
        ...
        while (opcion != 5) {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    System.out.println("El vertice X es: " + parab.Parabola_Equipo2_VerticeX(5.6f, 2));
                    System.out.println("El vertice Y es: " + parab.Parabola_Equipo2_VerticeY(5.96f, 3, 7.2f));
