...
//SETTERS y GETTERS//
    ...
    public void variables() {
        ...
        System.out.println("En el eje Y tanto hacia arriba y abajo: " + formato.format(this.a_hip));
        System.out.println("En el eje x tanto hacia derecha e izquierda: " + formato.format(this.b_hip));
